 ...
 16 00000018 1120FFFF BEQ $t1,$zero, mult:           # si il n'y a pas de reste alors on peut tester dans l'autre sens
...
.symtab
 16    .text:00000028 mult
 22    .text:00000036 mult
 33    .text:00000076 reussi
 38    .text:00000084 EXIT
