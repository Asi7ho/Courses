...
%
% written by Dima Pröfrock, downloaded from Matlab Central
% modified by Janusz Klejsa
...
function mov = yuv2mov(File)

% Values fixed for the purpose of Project 4
width = 176;
height = 144;
format = '420';
    ...
    if mod(framenumber,1) ~= 0
        ...
        for cntf = 1:1:framenumber
            ...
            % Project 4: Here you can access YUV components    
            mov(cntf).cdata = RGB;
            mov(cntf).colormap = [];
        end
        close(h);
